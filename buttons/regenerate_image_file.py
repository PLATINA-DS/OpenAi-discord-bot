...
class RegenerateImageButton(ui.View):
    ...
    async def regenerate(self, interaction: discord.Interaction, *args):
        ...
        regenerate_embed = discord.Embed(description="Image regeneration...",
                                         color=embed_color)
        not_available_embed = discord.Embed(description="Image regeneration is available only 3 times",
                                            color=embed_color)
